    ...
    return (
        <header className="relative w-full h-[500px] lg:h-[750px] flex flex-col items-center">
            ...
            <div className="relative w-full max-w-5xl h-full flex flex-col items-center">
                ...
                {/* The Monolithic Slab Wrapper */}
                <div className="absolute left-0 right-0 bottom-0 top-[100px] lg:top-[150px] overflow-hidden bg-white dark:bg-[#111] shadow-none flex flex-col items-center border-t border-x border-zinc-200 dark:border-zinc-800">
                    {/* 2. Hero Background */}
                    <Image
                        ...
                        fill
                        priority
                        className="object-cover object-bottom z-0 opacity-40 dark:opacity-20 pointer-events-none"
                        sizes="100vw"
                    />
                    ...
                    <div className="relative z-30 text-center px-6 max-w-4xl mx-auto mt-auto mb-16 md:mb-44">
                        ...
                        <p className="text-zinc-800 dark:text-zinc-100 tracking-[0.3em] font-sans uppercase text-[10px] md:text-xs max-w-xl mx-auto opacity-0 animate-[fade-in-up_1s_ease-out_0.6s_forwards] px-4 font-bold bg-white/10 dark:bg-black/10 backdrop-blur-sm py-2">
